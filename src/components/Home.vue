          ...
          <transition-group enter-active-class="animated zoomIn">
            <div v-for="(item,floors) in comments" :key="floors" class="message" :class="{me:item.isMe}">
              ...
              <div class="content" :class="{'align-right':item.isMe,'align-left':!item.isMe}">
                <p class="user" :class="{me:item.isMe}">{{item.nickname}} ({{item.prov}}{{item.city}})</p>
    ...
    methods: {
      readComments() {
        this.comments.push({
          ...
          prov: '成都',
          city: '温江',
          header: '/static/img/logo.jpg',
          content: '欢迎 ' + this.userInfo.nickname + ' 加入房间',
          isMe: 0
        });
        ...
        //     city: '成都',
        //     header: 'data:image/jpeg;base64,',
        //     content: '这里是吃瓜群众的一句留言，当然呢字数有一点点多啦',
        //     isMe: i % 2
        //   });
        // }
      },
      ...
      sendComment() {
        this.comments.push({
          nickname: this.userInfo.nickname,
          prov: this.userInfo.province,
          city: this.userInfo.city,
          header: this.userInfo.headimgurl,
          content: this.myChat,
          isMe: true
        });
        this.submitComment();
      ...
      submitComment(){
        ...
        this.$http.jsonp(this.cdnUrl+'/setUserComment', {
          params
        }).then(res => {
